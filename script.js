...
function munculbwh() {
    ...
    setTimeout(munculbwh2, 4000);
    otomatis();
}

// function fotobwh() {
//     kalimatbawah.innerHTML = fotobwh1.innerHTML;
//     setTimeout(fotobwh, 2000);
//     otomatis();
// }

function munculbwh2() {
    kalimatbawah.innerHTML = kalimatbawah2.innerHTML;
    setTimeout(munculbwh3, 4000);
    otomatis();
}

function munculbwh3() {
    kalimatbawah.innerHTML = kalimatbawah3.innerHTML;
    setTimeout(munculbwh, 4000);
    otomatis();
}
...
async function menuju() { window.location = "https://api.whatsapp.com/send?phone=+6281322336600&text=" + pesanwhatsapp; }
